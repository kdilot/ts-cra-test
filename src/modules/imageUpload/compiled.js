        ...
        },
        {
            ...
            value: function onDropFile(e) {
                ...
                Promise.all(allFilePromises).then(function (newFilesData) {
                    var dataURLs = singleImage
                        ? []
                        : _this2.state.pictures.slice();
     ...
     */
        },
        {
            ...
            value: function removeImage(picture) {
                ...
                var filteredPictures = this.state.pictures.filter(function (
                    e,
                    index,
                ) {
                    return index !== removeIndex;
                });
                var filteredFiles = this.state.files.filter(function (
                    e,
                    index,
                ) {
                    return index !== removeIndex;
            ...
            value: function renderErrors() {
                ...
                return fileErrors.map(function (fileError, index) {
                    return _react2.default.createElement(
                        ...
                        {
                            className:
                                'errorMessage ' + _this4.props.errorClass,
                            key: index,
